...
public class MetadataServiceTest {
  ...
  public void setUp() {
    ...
    metadataService.aclHelper = mock( IAclShadowNodeHelper.class );
  ...
  public void testGetMetadataDatasourceAcl() throws Exception {
    ...
    doReturn( true ).when( metadataService ).canAdministerCheck();
    when( metadataService.aclHelper.getAclFor( anyString(), any( IAclShadowNodeHelper.DatasourceType.class ) ) )
        .thenReturn( acl );
    ...
    verify( metadataService.aclHelper ).getAclFor( domainId, IAclShadowNodeHelper.DatasourceType.METADATA );
  ...
  public void testSetMetadataDatasourceAcl() throws Exception {
    ...
    verify( metadataService.aclHelper ).setAclFor( domainId, IAclShadowNodeHelper.DatasourceType.METADATA,
  ...
  public void testSetMetadataDatasourceAclNoAcl() throws Exception {
    ...
    verify( metadataService.aclHelper ).setAclFor( domainId, IAclShadowNodeHelper.DatasourceType.METADATA, null );
  }
}
