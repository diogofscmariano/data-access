...
public class DataSourceWizardService extends DatasourceService {
  ...
  public RepositoryFileAclDto getDSWAcl( String dswId ) throws PentahoAccessControlException {
    ...
    return getAcl( dswId, IAclShadowNodeHelper.DatasourceType.METADATA );
  }
  ...
  public void setDSWAcl( String dswId, RepositoryFileAclDto aclDto )
    ...
    aclHelper.setAclFor( dswId, IAclShadowNodeHelper.DatasourceType.MONDRIAN, acl );
    aclHelper.setAclFor( dswId, IAclShadowNodeHelper.DatasourceType.METADATA, acl );
  }
