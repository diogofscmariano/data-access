...
public class AnalysisService extends DatasourceService {
  ...
  public RepositoryFileAclDto getAnalysisDatasourceAcl( String analysisId ) throws PentahoAccessControlException {
    ...
    return repositoryFileAclAdapter.marshal(
        aclHelper.getAclFor( analysisId, IAclShadowNodeHelper.DatasourceType.MONDRIAN ) );
  }
  ...
  public void setAnalysisDatasourceAcl( String analysisId, RepositoryFileAclDto acl )
    ...
    aclHelper.setAclFor( analysisId, IAclShadowNodeHelper.DatasourceType.MONDRIAN,
  ...
  private IPlatformImportBundle createPlatformBundle( String parameters, InputStream dataInputStream,
    ...
    if ( acl != null ) {
      bundleBuilder.acl( repositoryFileAclAdapter.unmarshal( acl ) );
    }
